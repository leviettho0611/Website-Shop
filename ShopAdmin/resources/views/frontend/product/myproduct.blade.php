								...
								<table class="table table-condensed">
									...
									<tbody>
										...
										<tr>
											...
											<td class="cart_edit">
												<a class="cart_quantity_delete" href="{{ url('/shop/editproduct/'.$value->id) }}"><i class="fa fa-times"></i> edit </a>
											</td>
											<td class="cart_dedete">
												<a class="cart_quantity_delete" href="{{ url('/shop/deleteproduct/'.$value->id) }}"><i class="fa fa-times"> delete</i></a>
											</td>
										</tr>
										@endforeach
									</tbody>
